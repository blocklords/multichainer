 ...
 */
let smartcontract = {
    init: function(loomParams) {
        this.contract = loomParams.itemContract;
    },
    waitItemAppearance(itemId, timeOut) {     // @param addr - loom chain address mapped to ethereum account
