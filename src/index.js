...
let AddressMapper = require('./addressmapper');
let Gateway = require('./gateway');
let Utils = require('./cryptoutils');
...
class Multichainer {
    constructor (blockchain, network, sidechain = undefined) {
        ...
        this.init = function(loomParams, ethParams) {
        ...
        this.getProvider = function(loomParams, ethParams) {
